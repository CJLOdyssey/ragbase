...
def downgrade() -> None:
    ...
    if op.get_bind().dialect.name == "postgresql":
        with op.batch_alter_table('teams') as batch_op:
            batch_op.drop_constraint('fk_teams_workflow_config_id', type_='foreignkey')
        op.drop_column('teams', 'workflow_config_id')
    else:
        # SQLite cannot resolve named constraints via reflection; batch
        # recreate drops the inline FK together with the column.
        with op.batch_alter_table('teams') as batch_op:
            batch_op.drop_column('workflow_config_id')
    ...
    sa.Column('checkpoint_ns', sa.TEXT(), server_default="", autoincrement=False, nullable=False),
    ...
    sa.Column('checkpoint', postgresql.JSONB(astext_type=sa.Text()).with_variant(sa.JSON(), "sqlite"), autoincrement=False, nullable=False),  # noqa: E501
    sa.Column('metadata', postgresql.JSONB(astext_type=sa.Text()).with_variant(sa.JSON(), "sqlite"), server_default="{}", autoincrement=False, nullable=False),  # noqa: E501
    ...
    sa.Column('blob', postgresql.BYTEA().with_variant(LargeBinary(), "sqlite"), autoincrement=False, nullable=True),
    ...
    sa.Column('channel', sa.TEXT(), autoincrement=False, nullable=False),
    sa.Column('type', sa.TEXT(), autoincrement=False, nullable=True),
    sa.Column('blob', postgresql.BYTEA().with_variant(LargeBinary(), "sqlite"), autoincrement=False, nullable=False),
    sa.Column('task_path', sa.TEXT(), server_default="", autoincrement=False, nullable=False),
