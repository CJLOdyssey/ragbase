...
export const getWorkspaceTabs = (
  agentType: AgentType,
): { id: WorkspaceTab; labelKey: string; icon: LucideIcon }[] => {
  switch (agentType) {
    case 'ui':
      return [
    ...
    case 'frontend':
      return [
        {
          id: 'frontend-code',
          labelKey: 'workspace.tab.frontendCode',
          icon: Folder,
        },
        {
          id: 'frontend-test',
          labelKey: 'workspace.tab.frontendTest',
          icon: TestTube2,
        },
        {
          id: 'frontend-preview',
          labelKey: 'workspace.tab.frontendPreview',
          icon: Play,
        },
      ];
    case 'backend':
      return [
        {
          id: 'backend-code',
          labelKey: 'workspace.tab.backendCode',
          icon: Folder,
        },
        {
          id: 'backend-test',
          labelKey: 'workspace.tab.backendTest',
          icon: TestTube2,
        },
      ];
    default:
